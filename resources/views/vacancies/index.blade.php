...
<head> 
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrapicons.css" rel="stylesheet"> 
</head> 
<body class="bg-light"> 
        ...
        <div class="card shadow-sm mb-5 border-0"> 
            <div class="card-body p-4"> 
                ...
                <form action="{{ route('vacancies.store') }}" method="POST"> 
                    ...
                    <div class="row g-3"> 
                        <div class="col-md-6"> 
                            <label for="title" class="form-label font-weight-bold">Título do Cargo / Vaga <span class="text-danger">*</span></label> 
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title"
                            value="{{ old('title') }}" placeholder="Ex: Estágio em Desenvolvimento Web"> 
                            @error('title') 
                        ...
                        <div class="col-md-3"> 
                            ...
                            value="{{ old('company') }}" placeholder="Ex: Tech Solutions"> 
                            @error('company') 
                                <div class="invalid-feedback">{{ $message }}</div> 
                            @enderror 
                        </div> 
                        ...
                        <div class="col-12"> 
                            ...
                            name="requirements" rows="3" placeholder="Descreva os conhecimentos necessários, benefícios e diferenciais da vaga...">{{ old('requirements') }}</textarea> 
                            @error('requirements') 
                                <div class="invalid-feedback">{{ $message }}</div> 
                            @enderror 
                        </div> 
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-2 border-top"> 
                                        ...
                                        <div class="d-flex gap-1"> 
                                            ...
                                            <form action="{{ route('vacancies.destroy', $vacancy->id) }}" method="POST"> 
                                                @csrf 
                                                @method('DELETE') 
                                                <button type="submit" class="btn btn-sm btn-outline-danger" title="Excluir Vaga"
